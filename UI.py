...
def window():
    ...
    #place("Button", ("text = 'Vind het antwoord van het leven, het universum en alles'", "command = wow", "font=('arial', 5)"), ("column = 8", "row = 5"))
    #place("Button", ("text = 'Bombardeer China'", "bg = 'pink'", "command = term"), ("column = 8", "row = 8", "pady = 5"))
    ...
    place("Label", ("text = 'Huidige partijen:'", "bg = 'lightgreen'"), ("column = 8", "row = 10"))
    place("Label", ("textvariable = link", "bg = 'lightgreen'",), ("column = 8", "row = 11",))    
...
def term():
    ...
    canv = tk.Toplevel()
    test = ImageTk.PhotoImage( Image.open("Boem.jpeg") )
    tk.Label(canv, image = test).pack()
    canv.mainloop()
